            ...
            <el-table-column label="名称" min-width="260">
              <template slot-scope="scope">
                <div style="display: flex; align-items: center; cursor: pointer">
                  <div>
                    <img :src="scope.row.local_pic_url" class="shopImg">
                  </div>
...
<!--            <el-table-column label="类目" width="160" prop="cos_fee_scale" align="center">-->
<!--              <template slot-scope="scope">-->
...
<!--            <el-table-column label="月收入" width="120" prop="est_revenue" align="center" sortable :sort-method="sort_est_revenue">-->
<!--              <template slot-scope="scope">-->
<!--                <span>{{ scope.row.est_revenue|tranNumber }}</span>-->
<!--              </template>-->
<!--            </el-table-column>-->

<!--            <el-table-column label="月销量" width="120" prop="estimated_sales" align="center" sortable :sort-method="sort_estimated_sales">-->
<!--              <template slot-scope="scope">-->
...
<!--            <el-table-column label="价格|费用" width="140" prop="price" align="center" sortable :sort-method="sort_price">-->
<!--              <template slot-scope="scope">-->
<!--                <span>${{ scope.row.price }}|${{scope.row.fees}}</span>-->
<!--              </template>-->
<!--            </el-table-column>-->

<!--            <el-table-column label="排名" width="100" prop="rank" align="center" sortable :sort-method="sort_rank">-->
<!--              <template slot-scope="scope">-->
<!--                <span>{{ parseInt(scope.row.rank) }}</span>-->
<!--              </template>-->
<!--            </el-table-column>-->


            <el-table-column label="微信" width="120" prop="conversion_rate" align="center" sortable>
              <template slot-scope="scope">
